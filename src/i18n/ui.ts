...
export const ui = {
  en: {
    ...
    "word.wordItems.subtitle.9": "Practical: Only speak what can stand upon.",
    ...
    "zoom.title": "Join Our Zoom Sessions",
    "zoom.subtitle": "Connect with us online for prayer, worship, and fellowship",
